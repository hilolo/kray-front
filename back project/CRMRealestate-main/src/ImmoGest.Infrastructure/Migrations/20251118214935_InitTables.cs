    ...
    public partial class InitTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), "bassatine", "tanger", new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 857, DateTimeKind.Unspecified).AddTicks(7210), new TimeSpan(0, 0, 0, 0, 0)), "contact@immosyncpro.com", "51259111", null, new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 857, DateTimeKind.Unspecified).AddTicks(7211), new TimeSpan(0, 0, 0, 0, 0)), "IMMOSYNCPRO", "0605934495", "41414111", false, null, "www.immosyncpro.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), null, new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 639, DateTimeKind.Unspecified).AddTicks(8388), new TimeSpan(0, 0, 0, 0, 0)), "admin@admin.com", new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 639, DateTimeKind.Unspecified).AddTicks(8390), new TimeSpan(0, 0, 0, 0, 0)), null, "$2a$11$Ut.2OKEIOMrThj.Ievp7sOBOg2t7vIqvplhNXYzT9F709IOeOsLty", null, "Admin", null },
                    { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c2"), null, new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 749, DateTimeKind.Unspecified).AddTicks(6363), new TimeSpan(0, 0, 0, 0, 0)), "user@boilerplate.com", new DateTimeOffset(new DateTime(2025, 11, 18, 21, 49, 34, 749, DateTimeKind.Unspecified).AddTicks(6366), new TimeSpan(0, 0, 0, 0, 0)), null, "$2a$11$VhEjq3yY74DDcL3jV2N8yeAcf406l1nauac2i0n.he4FCX/puxch.", null, "User", null }
                });
