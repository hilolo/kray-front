    ...
    public partial class UpdateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), "bassatine", "tanger", new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 952, DateTimeKind.Unspecified).AddTicks(3200), new TimeSpan(0, 0, 0, 0, 0)), "contact@immosyncpro.com", "51259111", null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 952, DateTimeKind.Unspecified).AddTicks(3201), new TimeSpan(0, 0, 0, 0, 0)), "IMMOSYNCPRO", "0605934495", "41414111", false, null, "www.immosyncpro.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b2c3d4e5-f6a7-4890-b123-456789012345"), null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, null, true, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, "Lease", null, null, 2 },
                    { new Guid("c3d4e5f6-a7b8-4901-c234-567890123456"), null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, null, true, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, "Reservation Full", null, null, 3 },
                    { new Guid("d4e5f6a7-b8c9-4012-d345-678901234567"), null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, null, true, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, "Reservation Part", null, null, 4 },
                    { new Guid("e5f6a7b8-c9d0-4123-e456-789012345678"), null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, null, true, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, "Fees", null, null, 5 },
                    { new Guid("f6a7b8c9-d0e1-4234-f567-890123456789"), null, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, null, true, new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 965, DateTimeKind.Unspecified).AddTicks(5317), new TimeSpan(0, 0, 0, 0, 0)), null, "Deposit", null, null, 6 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), null, new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 742, DateTimeKind.Unspecified).AddTicks(8343), new TimeSpan(0, 0, 0, 0, 0)), "admin@admin.com", new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 742, DateTimeKind.Unspecified).AddTicks(8345), new TimeSpan(0, 0, 0, 0, 0)), null, "$2a$11$11gEHfSIKnIAJpGAxKegTusOkuBcE10i.A0EotxTodKD6x./iSKF2", null, "Admin", null },
                    { new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c2"), null, new Guid("687d9fd5-2752-4a96-93d5-0f33a49913c1"), new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 848, DateTimeKind.Unspecified).AddTicks(572), new TimeSpan(0, 0, 0, 0, 0)), "user@boilerplate.com", new DateTimeOffset(new DateTime(2025, 11, 23, 21, 40, 49, 848, DateTimeKind.Unspecified).AddTicks(573), new TimeSpan(0, 0, 0, 0, 0)), null, "$2a$11$Bo1zCTYPOF/CYudIde3wBu7truePvOzVcnB4nOAHN4/8g9o1.ZNV6", null, "User", null }
                });
