...
export const tabNavVariants = cva('flex gap-0 overflow-auto scroll nav-tab-scroll', {
  variants: {
    zPosition: {
...
export const tabButtonVariants = cva('hover:bg-transparent rounded-none flex-shrink-0 px-4 py-2 m-0', {
  variants: {
    zActivePosition: {
      top: '',
      bottom: '',
